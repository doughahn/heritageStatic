...
;(function ($, window, document, undefined) {
  ...
  var defaults = {
    ...
    // Templates
    'infowindowTemplatePath'     : '/scripts/storelocator_assets/js/plugins/storeLocator/templates/infowindow-description.html',
    'listTemplatePath'           : '/scripts/storelocator_assets/js/plugins/storeLocator/templates/location-list-description.html',
    'KMLinfowindowTemplatePath'  : '/scripts/storelocator_assets/js/plugins/storeLocator/templates/kml-infowindow-description.html',
    'KMLlistTemplatePath'        : '/scripts/storelocator_assets/js/plugins/storeLocator/templates/kml-location-list-description.html',
    'listTemplateID'             : null,
          ...
          if (_this.settings.maxDistance === true && maxDistance) {
            ...
            if (typeof locationset[0] !== 'undefined') {
              if (_this.settings.distanceAlert !== -1 && locationset[0].distance > _this.settings.distanceAlert) {
                ...
                // var div = document.getElementById('InlineDistanceError');
                // theDiv.innerHTML += "<h3>No Locations within 60 miles.</h3>";                 
                // var theDiv = document.getElementById("InlineDistanceError");
                // var content = document.createTextNode("There are no locations within 60 miles.");

                
                if($('#theInlineDistanceError').length < 1){
                  $("#InlineDistanceError").append('<span id="theInlineDistanceError">There are no locations within 60 miles.</span>');  
                }  
                distError = true;
              }
              else {
                $("#InlineDistanceError").remove();  
              }
            }
            else {
