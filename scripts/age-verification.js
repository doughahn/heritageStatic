...
av_showmodal = function() {
  ...
  var content_heading = $('<h2>Are you of legal drinking age in your country of residence?</h2>');
  var modal_content_wrapper = $('<div id="modal_content_wrapper"></div>');
  var modal_content_wrapper = $('<div class="content_wrapper"></div>');
  ...
  var content_text = $('<p class="privacy-link"><a href="/privacy-policy">Privacy Policy</a></p>');
...
av_showRegret = function() {
  ...
  modal_content.find('.content_wrapper').hide();
  modal_content.find('#modal_regret_wrapper').show();
};

av_positionPrompt = function() {
  var top = ($(window).outerHeight() - $('#modal_content').outerHeight()) / 4;
